...
public class Conf {
  ...
  public static volatile String DOMAIN = "animekai.to";
  ...
  public static volatile int CACHE_SIZE_MB = 100;

  /* Type de flux prefere (reglage utilisateur) */
  public static volatile int STREAM_TYPE = 0;

  /* Lecture progressive via le cache reseau */
  public static volatile boolean PROGRESSIVE_CACHE = false;

  /* Utiliser le DNS-over-HTTPS (1.1.1.1) */
  public static volatile boolean USE_DOH = true;

  /* Moteur HTTP : 0 = OkHttp, 1 = HttpURLConnection, 2 = Cronet */
  public static volatile int HTTP_CLIENT = 0;

  /* Identifiant client MyAnimeList */
  public static volatile String MAL_CLIENT_ID = "0e9466e5ec09684cc69da53f20b07af6";

  /* User-Agent utilise partout (WebView, proxy, lecteur) */
  public static volatile String USER_AGENT =
